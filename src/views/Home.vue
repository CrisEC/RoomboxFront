    ...
    <div class="wrapper fadeInDown">
      <div id="formContent">
        ...
        <div class="fadeIn first">
          <img src="../assets/logo.jpg" id="icon" alt="Roombox logo" />
        </div>
...
export default {
  ...
  methods:{
    login(){
      ...
      axios.post('http://localhost/proyectoApiRest/auth',json)
      .then(data =>{
        console.log(data.data);
        if(data.data.statusMsg.status){
          ...
          this.error=true;
          this.error_msg=data.data.statusMsg.message;
          }
      });
